...
function TechStack() {
  return (
    <div className="TechStack">
        ...
        <p className="paragraph paragraph--1">React is by far one of my favourite and core frameworks I work with. Here is a list of more technologies/frameworks I know.</p>
        <div className="TechStack_items">
            ...
            <div className="TechStack_items_row">
                ...
                <div className="TechStack_item"><span className="TechStack_item_text paragraph paragraph--2">Figma</span></div>
