...
function AboutMe() {
  return (
    <div className="AboutMe">
        ...
        <a href="https://www.dropbox.com/s/xty2n3gmhjeof8e/Jordan%20Binnie%20Resume.pdf?dl=0" target="_blank" rel="noreferrer"><button className="button resume-button paragraph--2">Resume</button></a>
    </div>
  )
}
