...
function AboutMe() {
  return (
    <div className="AboutMe">
        ...
        <a href="https://www.dropbox.com/s/401kkqf5oys9su2/Jordan%20Binnie.pdf?dl=0" target="_blank"><button className="button resume-button paragraph--2">Resume</button></a>
    </div>
  )
}
