...
function AboutMe() {
  return (
    <div className="AboutMe">
        ...
        <a href="https://www.dropbox.com/s/nrnlnoemlaaze23/Jordan%20Binnie.pages?dl=0" target="_blank"><button className="button resume-button paragraph--2">Resume</button></a>
    </div>
  )
}
